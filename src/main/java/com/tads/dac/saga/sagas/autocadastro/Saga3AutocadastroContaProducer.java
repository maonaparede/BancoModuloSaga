...
@Component
public class Saga3AutocadastroContaProducer{
    ...
    public void commitOrdem(MensagemDTO dto) {
        template.convertAndSend(ConfigProducersAutocadastro.queueAutoContaCommit, dto);
    }
    ...
    public void rollbackOrdem(MensagemDTO msg) {
        if(msg.getSagaId() != null){
            ...
            if(model.isPresent()){
                ...
                msg.setSendObj(dto);
                template.convertAndSend(ConfigProducersAutocadastro.queueAutoContaRollback, msg);
